...
const PROGRAM_DATA =
{
  ...
  "warmupExercises": [
    ...
    {"key": "hipcirc", "name": "Hip Circles",     "detail": "8 each side",         "link": "https://www.youtube.com/watch?v=VH7d6CkEBY4"},
    {"key": "armcirc", "name": "Arm Circles",     "detail": "10 forward + 10 back","link": "https://www.youtube.com/watch?v=X1sYqAC9nHM"}
  ],

  "cooldownSets": {
    "1": [
      {"key": "childpose", "name": "Child's Pose",              "detail": "Hold 30s",       "link": "https://www.youtube.com/watch?v=2MJGg-dUKh0"},
      {"key": "hipflexor", "name": "Lying Hip Flexor Stretch",  "detail": "30s each side",  "link": "https://www.youtube.com/watch?v=YQmpTOQgZqI"},
      {"key": "chestopen", "name": "Chest Opener Stretch",      "detail": "Hold 30s",       "link": "https://www.youtube.com/watch?v=cBe1xt-6QBE"}
    ],
    "2": [
      {"key": "pigeon",    "name": "Pigeon Pose",               "detail": "40s each side",  "link": "https://www.youtube.com/watch?v=24nKXO4VNYQ"},
      {"key": "tricepstr", "name": "Overhead Tricep Stretch",   "detail": "30s each arm",   "link": "https://www.youtube.com/watch?v=GKDVF2g3aZA"},
      {"key": "cobra",     "name": "Cobra Stretch",             "detail": "Hold 30s",       "link": "https://www.youtube.com/watch?v=JDl_q5m19jA"}
    ],
    "3": [
      {"key": "figure4",    "name": "Figure-4 Hip Stretch",     "detail": "40s each side",  "link": "https://www.youtube.com/watch?v=nzLkv9AAaKc"},
      {"key": "tricepstr2", "name": "Overhead Tricep Stretch",  "detail": "30s each arm",   "link": "https://www.youtube.com/watch?v=GKDVF2g3aZA"},
      {"key": "catcow2",    "name": "Cat-Cow Flow",             "detail": "6 slow reps",    "link": "https://www.youtube.com/watch?v=kqnua4rHVVA"}
    ],
    "4": [
      {"key": "pigeon2",     "name": "Pigeon Pose",             "detail": "45s each side",  "link": "https://www.youtube.com/watch?v=24nKXO4VNYQ"},
      {"key": "fwdfold",     "name": "Seated Forward Fold",     "detail": "Hold 45s",       "link": "https://www.youtube.com/watch?v=Fh-smPKLfb0"},
      {"key": "doorway",     "name": "Doorway Chest Stretch",   "detail": "Hold 30s",       "link": "https://www.youtube.com/watch?v=WMb-jbYnI3Q"},
      {"key": "spinaltwist", "name": "Supine Spinal Twist",     "detail": "30s each side",  "link": "https://www.youtube.com/watch?v=XrEiPJKLPsc"}
    ]
  },
  ...
  "exercises": {
    ...
    "pelvicTilt":         {"name": "Supine Pelvic Tilt",             "target": "Lower abs, APT correction",      "tip": "Flatten lower back to mat by squeezing glutes and drawing navel in.",      "link": "https://www.youtube.com/watch?v=BxtzqQilHDM"},
    ...
    "reverseCrunch":      {"name": "Reverse Crunch",                 "target": "Lower abs, APT correction",      "tip": "Curl hips up using lower abs — no momentum.",                              "link": "https://www.youtube.com/watch?v=Wf7uVBsZ8go"},
    ...
    "innerThighSqueezeB": {"name": "Lying Inner Thigh Squeeze",      "target": "Inner thighs (adductors)",       "tip": "Use a pillow or fist between knees. Squeeze and hold 3 sec.",              "link": "https://www.youtube.com/watch?v=7-oTLvA5zio"},
    "sumoSquat":          {"name": "Sumo Squat",                     "target": "Inner thighs, glutes, quads",    "tip": "Toes out 45°, knees track over toes. Sit deep.",                           "link": "https://www.youtube.com/watch?v=xMGNBF8MD1c"},
    "innerThighLift":     {"name": "Side-Lying Inner Thigh Lift",    "target": "Inner thighs (adductors)",       "tip": "Bottom leg lifts. Foot flexed. Don't let hip roll back.",                  "link": "https://www.youtube.com/watch?v=lTwPCgmDqNE"},
    "plateSumoSquat":     {"name": "Sumo Squat Pulse",               "target": "Inner thighs, glutes",           "tip": "Hold the bottom position, pulse 1 inch up and down.",                      "link": "https://www.youtube.com/watch?v=xMGNBF8MD1c"},
    "lateralLunge":       {"name": "Lateral Lunge",                  "target": "Inner thighs, glutes",           "tip": "Push hips back, chest up. Straight leg feels the stretch.",                "link": "https://www.youtube.com/watch?v=1r2nfj9VPvA"},
    ...
    "wallPushUp":         {"name": "Wall Push-Up",                   "target": "Chest, triceps, shoulders",      "tip": "Straight body line. Lower chest to wall, push back.",                      "link": "https://www.youtube.com/watch?v=PKbAMoWvW1s"},
    ...
    "frontRaise":         {"name": "Front Raise (1kg)",              "target": "Front deltoids, arms",           "tip": "Arms straight, raise to shoulder height. Control down.",                   "link": "https://www.youtube.com/watch?v=gkdluM7VSGI"},
  ...
  "tennisWarmup": [
    {"key": "tw_jog",           "name": "Light Jog in Place",            "detail": "60 seconds",                              "link": "https://www.youtube.com/watch?v=ZKNqH1BNKFE", "tip": "Gets blood flowing to legs before clay court movement."},
    {"key": "tw_legswing",      "name": "Leg Swings (Front & Side)",     "detail": "10 each leg, each direction",             "link": "https://www.youtube.com/watch?v=PNJ3QYlJwrw", "tip": "Opens hip flexors — essential for clay court lateral movement."},
    {"key": "tw_hiprot",        "name": "Hip Rotation Stretch",          "detail": "8 circles each direction",                "link": "https://www.youtube.com/watch?v=VH7d6CkEBY4", "tip": "Primes the hips for the explosive rotational demands of clay."},
    {"key": "tw_shoulderroll",  "name": "Shoulder Rolls & Arm Cross",    "detail": "10 forward, 10 back, 20s cross stretch",  "link": "https://www.youtube.com/watch?v=X1sYqAC9nHM", "tip": "Warms up serving and forehand/backhand shoulder muscles."},
    {"key": "tw_anklecirc",     "name": "Ankle Circles & Calf Raise",    "detail": "10 each ankle + 15 calf raises",          "link": "https://www.youtube.com/watch?v=4J9M6nXE_eU", "tip": "Clay is slippery — ankle stability is critical before stepping on court."},
    {"key": "tw_lateralstep",   "name": "Lateral Side Steps",            "detail": "10 each side — wide stance",              "link": "https://www.youtube.com/watch?v=1oRd81Kj0VY", "tip": "Mimics clay court footwork. Wide stance, stay low."}
  ],

  "tennisStretches": [
    {"key": "ts_quad",      "name": "Standing Quad Stretch",         "detail": "30s each leg",  "link": "https://www.youtube.com/watch?v=y3m7MwDgDtg", "tip": "Clay play is hard on quads from low stances — stretch immediately after."},
    {"key": "ts_calf",      "name": "Calf Stretch (Wall)",           "detail": "30s each leg",  "link": "https://www.youtube.com/watch?v=9-9FZQJ3t6Y", "tip": "Prevents tightness from explosive clay court starts and stops."},
    {"key": "ts_hip",       "name": "Pigeon Pose Hip Stretch",       "detail": "40s each side", "link": "https://www.youtube.com/watch?v=24nKXO4VNYQ", "tip": "Releases hip flexors after all that lateral movement."},
    {"key": "ts_shoulder",  "name": "Cross-Body Shoulder Stretch",   "detail": "30s each arm",  "link": "https://www.youtube.com/watch?v=OkLHSMpJGno", "tip": "Cool down the serving shoulder to prevent rotator cuff tightness."},
    {"key": "ts_hamstring", "name": "Seated Hamstring Stretch",      "detail": "40s each leg",  "link": "https://www.youtube.com/watch?v=Fh-smPKLfb0", "tip": "Hamstrings take a beating on clay — long hold here."},
    {"key": "ts_spinal",    "name": "Supine Spinal Twist",           "detail": "30s each side", "link": "https://www.youtube.com/watch?v=XrEiPJKLPsc", "tip": "Decompresses the spine after serving and ground-stroke rotation."}
  ],
